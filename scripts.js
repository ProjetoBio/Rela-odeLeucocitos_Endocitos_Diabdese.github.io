...
function showDetailedText(imageIndex) {
    ...
    <ul>
        ...
        <li><strong>Aterosclerose</strong>: O recrutamento excessivo de leucócitos contribui para o desenvolvimento de placas ateroscleróticas.</li>
                 ...
                 <iframe src="https://www.youtube.com/embed/UJMjf9Ye6wk?si=8Q91ckFQcj6hP8zq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" title="YouTube video player" allowfullscreen></iframe>
            `;
            break;
        case 3:
            content = `
